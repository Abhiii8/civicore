...
class TemplateVisualEditorFixed extends StatefulWidget {
  ...
  const TemplateVisualEditorFixed({
    super.key,
  ...
  @override
  State<TemplateVisualEditorFixed> createState() => _TemplateVisualEditorFixedState();
}

class _TemplateVisualEditorFixedState extends State<TemplateVisualEditorFixed> {
            ...
            child: InteractiveViewer(
              ...
              child: GestureDetector(
                onTapDown: (details) {
                  ...
                  if (box != null && _selectedField != null) {
